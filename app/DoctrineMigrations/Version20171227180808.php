 ...
 */
class Version20171227180808 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ingredient ADD note LONGTEXT DEFAULT NULL, DROP description, CHANGE unit_id recipe_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE unit (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ingredient ADD description LONGTEXT NOT NULL COLLATE utf8_unicode_ci, DROP note, CHANGE recipe_id unit_id INT DEFAULT NULL');
